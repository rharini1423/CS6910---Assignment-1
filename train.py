...
Original file is located at
    https://colab.research.google.com/drive/1qrSv0Hf929jDtjYiMLAuTOtP5Ye1UHa0
"""
...
labels_unique = np.unique(trainy)
...
wandb.init(project='Deep Learning', entity='rharini1423-coimbatore-institute-of-technology', name='question1')
...
for i, label in enumerate(unique_labels):
    ...
    plt.axis('off')
    img = trainX[index]
    wandb_images.append(wandb.Image(img, caption=class_names[label]))
plt.show()
wandb.log({"Question 1 - Sample Images from Fashion-MNIST": wandb_images})
...
def train(Xtr, ytr, Xval, yval, sizes, opt_name='adam', epochs=10, bs=64, lr=0.001, wd=0.0, init='random', act='relu'):
...
def sweep_train():
    ...
    config = wandb.config
    wandb.run.name = f"hl_{config.num_hidden_layers}_bs_{config.batch_size}_ac_{config.activation}"
